...
| **COMP2823** <br> (Rosy's version) | Data Structures and Algorithms (Advanced) | [A4 cheatsheet](https://github.com/Wendyfff0616/USYD-Learning-Notes/blob/main/COMP2823_cheatsheet_Rosy.docx) <br> (by Rosy, based on COMP2123) | 📄 Available |
...
| **COMP3308** | Introduction to Artificial Intelligence | [A4 cheatsheet](https://github.com/Wendyfff0616/USYD-Learning-Notes/blob/main/COMP3308_cheatsheet.pdf) | 📄 Available |
| **COMP3308** <br> (Rosy's version) | Introduction to Artificial Intelligence | [A4 cheatsheet](https://github.com/Wendyfff0616/USYD-Learning-Notes/blob/main/COMP3308_cheatsheet_Rosy.pdf) <br> (by Rosy, variant) | 📄 Available |
...
| Unit Code | Unit Name | Study Materials | Status |
|-----------|-----------|-----------------|--------|
| **MATH1064** | Discrete Mathematics for Computer Science | [Review notes](https://github.com/Wendyfff0616/USYD-Learning-Notes/blob/main/MATH1064_Review_Notes.docx) | 📄 Available |

## 🎨 Design Files

Original Figma files used to create the cheat sheets are available for editing and customization:
